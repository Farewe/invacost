  ...
  summary.models <- 
    ...
    as.array(rbind(
      ...
      rbind(c("", "Estimate", "Standard error", "t value", "p-value", ""),
            ...
            c("", "Min", "25%", "50%", "75%", "Max"),
            c("", quantile(x$model.summary$robust.linear$rweights)),
      ...
      rbind(c("", "Estimate", "Standard error", "t value", "p-value", ""),
            ...
            c("Summary of model weights", rep("", 5)),
            c("", "Min", "25%", "50%", "75%", "Max"),
            c("", quantile(x$model.summary$robust.quadratic$rweights)),
            c("", "Number of outliers", rep("", 4)),
      ...
      rbind(cbind("", 
            ...
            c("Intercept", earth:::get.varmod.coef.tab(x$model.summary$mars$varmod)[1, ], "", ""),
            c("Intercept", earth:::get.varmod.coef.tab(x$model.summary$mars$varmod)[2, ], "", ""),
            "",
