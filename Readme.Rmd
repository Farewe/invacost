...
author: "Leroy B, Kramer A, Vaissière AC & Diagne C"
date: "11/08/2020"
output:
  github_document:
    toc: true
...
to biological invasions.
 ...
 - *Modelling approach*: the second approach consists in **estimating** the long-term trend in annual cost 
...
**The package requires at least R 4.0.0.** *FYI, the main difference (for you)
between R4.0.0+
...
- Added a new model to model the trend of costs over time, namely robust
...
In this example, expanded database is here stored in an object called `db.over.time`.
...
This approach requires more data than the approach based on available estimates  and for data-poor cases it
...
Customising plots for the modelling approach similar to the approach based on available estimates: 
