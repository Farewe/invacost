...
If R requests you to install some packages from source, and you are unsure what
to do, say no: you do not need the very last version of every package to make it
work.
