...
Cost estimate (either the ‘Raw cost estimate local currency’ extracted
from analysed paper or the `Cost_estimate_per_year_original_currency`
transformed by us), **C<sub>F</sub>** = Conversion factor (either the
official market exchange rate or the purchasing power parity, in US
dollars), **I<sub>F</sub>** = Inflation factor since the year of cost
estimation, calculated as CPI<sub>2017</sub> / CPI<sub>y</sub> with CPI
...
```
    ...
    ## Coefficients:
    ##               Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) -97.892418   9.175961  -10.67 1.17e-13 ***
    ...
    ## <environment: 0x0000000022457788>
    ## ~s(Year, k = gam.k)
    ## <environment: 0x0000000022457788>
    ## 
    ...
    ## GCV 0.1267195  RSS 3.255282  GRSq 0.8060323  RSq 0.8841804  CVRSq 0.6864894
    ## 
    ## Note: the cross-validation sd's below are standard deviations across folds
    ## 
    ## Cross validation:   nterms 2.57 sd 1.19    nvars 1.00 sd 0.00
    ## 
    ##      CVRSq    sd     MaxErr   sd
    ##      0.686 0.193       1.37 0.79
    ## 
    ## varmod: method "lm"    min.sd 0.0338    iter.rsq 0.017
    ## 
    ## stddev of predictions:
    ##             coefficients iter.stderr iter.stderr%
    ## (Intercept)   0.17848714    0.184369          103
    ## transf.cost   0.04017794   0.0472777          118
    ## 
    ##                              mean   smallest    largest      ratio
    ## 95% prediction interval   1.32344   1.091578   1.568493   1.436904
    ## 
    ##                                          68%    80%    90%    95% 
...
```
    ...
    ## 32                                                                 Estimate
    ## 33                                    Intercept           -3184.16168277354
    ## 34                                         Year            3.15003560697585
    ## 35                                                                         
    ## 36                                                              Adjusted R²
    ## 37                                                         0.80166718193872
    ## 38                                                                         
    ...
    ## 57                               Variance model                            
    ## 58                                                                 Estimate
    ## 59                                    Intercept           0.178487137861361
    ## 60                                    Intercept          0.0401779375003546
    ## 61                                                                         
    ## 62                                                    R² for last iteration
    ## 63                                                       0.0165181052983213
    ...
    ## 19                9.17596062083338            -10.6683564212634
    ## 20             0.00461676956941964             11.0715520563425
    ## 21                                                             
    ## 22                              R²                             
    ...
    ## 33                1363.27362963442            -2.33567320129813
    ## 34                1.36871457129709              2.3014554480783
    ## 35                                                             
    ## 36                              R²                             
    ## 37               0.810682310032415                             
    ## 38                                                             
    ## 39                                                             
    ## 40                             25%                          50%
    ## 41               0.886348162613181            0.959271810557674
    ## 42                                                             
    ## 43                                                             
    ## 44               _________________            _________________
    ## 45                                                             
    ...
    ## 59               0.184369038911851             103.295420118764
    ## 60              0.0472777152428755              117.67083674332
    ## 61                                                             
    ## 62                                                             
    ## 63                                                             
    ## 64               _________________            _________________
    ...
    ## 17                                       
    ## 18              p-value                  
    ## 19 1.16817423678964e-13                  
    ## 20 3.59413546548181e-14                  
    ## 21                                       
    ## 22                                       
    ## 23                                       
    ## 24                                       
    ...
    ## 31                                       
    ## 32              p-value                  
    ## 33   0.0243578366758127                  
    ## 34   0.0263953063926739                  
    ## 35                                       
    ## 36                                       
    ## 37                                       
    ## 38                                       
    ## 39                                       
    ## 40                  75%               Max
    ## 41    0.982954510411987  0.99997720965658
    ## 42                                       
    ## 43                                       
    ## 44    _________________ _________________
    ## 45                                       
